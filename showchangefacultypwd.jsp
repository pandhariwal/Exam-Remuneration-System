		...
		if(npwd.equals(cnpwd))
			{
				...
				try{
					...
					String q="update login SET password='"+npwd+"' WHERE userid='"+user+"' and password='"+pwd+"' and fid='"+fid+"'";
...
<div align=center><font face="Berlin Sans FB" class="ws24">Password Changed Successfully</font></div>
</div></div>
...
<div align=center><font face="Berlin Sans FB" class="ws24"><BR></font></div>
<div align=center><font face="Berlin Sans FB" class="ws24">Unable To Change Password</font></div>
</div></div>
...
<% 
		...
		{
	%>
<div id="text3" style="position:absolute; overflow:hidden; left:461px; top:290px; width:535px; height:122px; z-index:3">
<div class="wpmd">
<div align=center><font face="Berlin Sans FB" class="ws24">Sorry!!!!!</font></div>
<div align=center><font face="Berlin Sans FB" class="ws24"><BR></font></div>
<div align=center><font face="Berlin Sans FB" class="ws24">The Passwords Donot Match</font></div>
</div></div>
