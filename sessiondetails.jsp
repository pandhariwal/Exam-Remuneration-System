...
%>
<div id="image2" style="position:absolute; overflow:hidden; left:0px; top:0px; width:1348px; height:642px; z-index:0"><img src="images/template_main_01.jpg" alt="" title="" border=0 width=1348 height=642></div>

<form name="form1" method="POST" action="showsessiondetails.jsp" style="margin:0px">
<select name="sess" style="position:absolute;left:513px;top:315px;width:200px;z-index:3">
<option value=""></option>
<% 
	String q=null; 
...
<input name="sessiondetails" type="submit" value="  Get Session Details  " style="position:absolute;left:514px;top:367px;z-index:4">
</form>

<div id="text1" style="position:absolute; overflow:hidden; left:526px; top:294px; width:179px; height:27px; z-index:2">
<div class="wpmd">
<div align=center><font face="@FangSong" class="ws14"><B>Select Session</B></font></div>
</div></div>

<div id="image1" style="position:absolute; overflow:hidden; left:313px; top:10px; width:734px; height:106px; z-index:5"><img src="images/Banner1.png" alt="" title="" border=0 width=734 height=106></div>
