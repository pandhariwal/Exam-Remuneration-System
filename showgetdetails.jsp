...
<% 
		...
		Statement st = null;
		 try{
				 ...
				 String q="select title,first_name,last_name,relation.subcode,subname,relation.course,relation.branch,section,value,numpset,numpeva,amount from relation,faculty,subject,session,login where faculty.fid=login.fid and faculty.fid='"+fid+"' and faculty.fid=relation.fid and relation.subcode='"+subcode+"' and relation.subcode=subject.subcode and relation.session='"+sess+"' and relation.session=session.session";
				 ResultSet rs=st.executeQuery(q);
				if(rs.next())
			{
%>
<center><h1>Session-Subject-Faculty Report </h1>
