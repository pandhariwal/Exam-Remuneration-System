...
<% 
		...
		Statement st = null;
		 try{
				 ...
				 String q="update faculty SET first_name='"+fname+"', last_name='"+lname+"',designation='"+designation+"',department='"+dept+"',contact='"+contact+"',email_id='"+email+"' WHERE fid='"+fid+"'";
...
<div align=center><font face="Berlin Sans FB" class="ws24">Faculty Details Updated Successfully</font></div>
</div></div>
...
<div align=center><font face="Berlin Sans FB" class="ws24"><BR></font></div>
<div align=center><font face="Berlin Sans FB" class="ws24">Unable To Update Faculty Details</font></div>
</div></div>
