...
<% 
		...
		int pstamt=0,minevaamt=0,percpyamt=0,amount;
		Connection con = null;
		Statement st = null;
		 try{
				 ...
				 st=con.createStatement();
					...
					if(rs.next())
					{
				 	...
				 	q="insert into relation values('"+fid+"','"+subcode+"','"+course+"','"+branch+"','"+section+"','"+sess+"',"+numpset+","+numpeva+","+amount+")";
...
<div align=center><font face="Berlin Sans FB" class="ws24">New Record Added Successfully</font></div>
</div></div>
...
<div align=center><font face="Berlin Sans FB" class="ws24"><BR></font></div>
<div align=center><font face="Berlin Sans FB" class="ws24">Unable To Add New Record</font></div>
</div></div>
