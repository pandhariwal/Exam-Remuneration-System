...
<form name="form1" method="Post" action="searchmodify2.jsp"style="margin:0px">
...
<%  
		...
		{	e.printStackTrace();}
%>
<input name="update" type="submit" value="Find Record" style="position:absolute;left:705px;top:564px;z-index:19">
</form>
